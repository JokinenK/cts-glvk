...
typedef enum CtsCommandType {
    CTS_COMMAND_CREATE_BUFFER,
    CTS_COMMAND_BIND_BUFFER_MEMORY,
    CTS_COMMAND_DESTROY_BUFFER,

    CTS_COMMAND_CREATE_COMMAND_POOL,
    CTS_COMMAND_DESTROY_COMMAND_POOL,

    CTS_COMMAND_CREATE_DESCRIPTOR_POOL,
    CTS_COMMAND_DESTROY_DESCRIPTOR_POOL,

    CTS_COMMAND_CREATE_DESCRIPTOR_SET_LAYOUT,
    CTS_COMMAND_DESTROY_DESCRIPTOR_SET_LAYOUT,
    ...
    CTS_COMMAND_CREATE_PIPELINE_LAYOUT,
    CTS_COMMAND_DESTROY_PIPELINE_LAYOUT,

    CTS_COMMAND_CREATE_SHADER_MODULE,
    CTS_COMMAND_DESTROY_SHADER_MODULE,

    CTS_COMMAND_CREATE_FENCE,
    CTS_COMMAND_DESTROY_FENCE,

    CTS_COMMAND_ALLOCATE_COMMAND_BUFFERS,
    CTS_COMMAND_FREE_COMMAND_BUFFERS,
    ...
    CTS_COMMAND_QUEUE_SUBMIT,

    CTS_COMMAND_BEGIN_COMMAND_BUFFER,
    CTS_COMMAND_RESET_COMMAND_BUFFER,
    CTS_COMMAND_END_COMMAND_BUFFER,
